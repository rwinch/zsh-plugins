...
----
$ merge-dependency-upgrades
⏭️  Skipping https://github.com/spring-projects/spring-security/pull/12344 - 1 check(s) not passed: CI Build

Merging https://github.com/spring-projects/spring-security/pull/12345
✅ Merged successfully: Bump spring-core from 6.0.0 to 6.0.1

Merging https://github.com/spring-projects/spring-security/pull/12346
✅ Merged successfully: Bump junit from 5.9.0 to 5.9.1

Merging https://github.com/spring-projects/spring-security/pull/12347
❌ Merge conflict detected for: Bump jackson from 2.14.0 to 2.15.0
📝 URL: https://github.com/spring-projects/spring-security/pull/12347
...
[Press Enter]
✅ Merge completed successfully! Continuing with next PR...
----
